...
/// @title TstICO contract - Takes funds from users and issues tokens.
/// @author Evgeny Yurtaev - <evgeny@etherionlab.com>
/// @author Alexey Bashlykov - <alexey@etherionlab.com>
contract TstICO is SafeMath {

    /*
     * External contracts
     */
    TstToken public tstToken;
    ...
    uint public startDate = 1523223647;  // 2017-04-05 23:00:00 UTC

    // End date of the ICO
    uint public endDate = 1523396447;  // 2017-04-26 23:00:00 UTC
    ...
    {   
        ...
        // Distribute tokens.
        if (!tstToken.transferFrom(allocationAddress, beneficiary, tokenCount)) {
    ...
    function TstICO(address tokenAddress, address founderAddress) {
        // Set token address
        tstToken = TstToken(tokenAddress);
